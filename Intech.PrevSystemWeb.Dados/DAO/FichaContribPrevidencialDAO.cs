...
namespace Intech.PrevSystemWeb.Dados.DAO
{
	public abstract class FichaContribPrevidencialDAO : BaseDAO<FichaContribPrevidencialEntidade>
	{
		...
		public virtual List<FichaContribPrevidencialEntidade> BuscarPorContratoPlanoFundo(int SQ_CONTRATO_TRABALHO, int SQ_PLANO_PREVIDENCIAL, int SQ_TIPO_FUNDO)
		{
			try
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
		...
		public virtual List<FichaContribPrevidencialEntidade> BuscarUltimaPorContratoPlano(int SQ_CONTRATO_TRABALHO, int SQ_PLANO_PREVIDENCIAL)
		{
			try
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
