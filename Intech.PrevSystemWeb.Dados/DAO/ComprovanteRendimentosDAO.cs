...
namespace Intech.PrevSystemWeb.Dados.DAO
{
	...
	{
		public virtual List<ComprovanteRendimentosEntidade> BuscarDatasPorCdPessoa(int CD_PESSOA)
		{
			try
			{
				if (AppSettings.IS_SQL_SERVER_PROVIDER)
					return Conexao.Query<ComprovanteRendimentosEntidade>("SELECT DISTINCT       EX.ANO_EXERCICIO,      EX.ANO_CALENDARIO   FROM FI_COMPROVANTE_RENDIMENTOS CR  INNER JOIN FI_EXERCICIO_TRIBUTO EX ON EX.SQ_EXERCICIO = CR.SQ_EXERCICIO  WHERE CR.CD_PESSOA = @CD_PESSOA", new { CD_PESSOA }).ToList();
